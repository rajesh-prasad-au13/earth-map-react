...
export default function EarthViewer() {
  ...
  return (
    <div style={{ position: "relative" }}>
      {/* Intro Screen */}
      {showIntro && <IntroScreen onStart={handleStartExploration} />}

      {/* Main 3D container */}
      <div ref={containerRef} />

      {/* Country Info Overlay - Show if enabled in settings */}
      {state.ui.showCountryInfo && selectedCountry && (
        <div
          style={{
            position: "absolute",
            top: "20px",
        ...
        >
          <h3 style={{ margin: "0 0 5px 0" }}>Selected Country</h3>
          <p style={{ margin: "0" }}>{selectedCountry.countryName}</p>
      ...
      {/* Hover Info - Show if enabled in settings */}
      {state.ui.showCountryInfo && hoveredCountry && !selectedCountry && (
        <div
          style={{
            position: "absolute",
            top: "20px",
